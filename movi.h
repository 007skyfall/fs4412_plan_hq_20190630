...
#define PART_SIZE_ROOTFS	(10 * 1024 * 1024)//  2M
#define PART_SIZE_DTB		(1 * 1024 * 1024)// 16MB

#define RAW_AREA_SIZE 		(20 * 1024 * 1024)
	...
	#define MOVI_DTB_BLKCNT		(PART_SIZE_DTB/MOVI_BLKSIZE)
